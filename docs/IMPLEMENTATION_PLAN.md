...
- Milestone 4: complete. Hierarchical llama.cpp JSON summaries, validation, evidence, action items, decisions, questions, transcript versions, summary regeneration/history/restore.
